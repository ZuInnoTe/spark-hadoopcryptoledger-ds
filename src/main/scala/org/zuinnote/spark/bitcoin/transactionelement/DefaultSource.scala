...
class DefaultSource
  ...
  override def createRelation(
      ...
      parameters: Map[String, String]): BitcoinTransactionElementRelation = {
      ...
      BitcoinTransactionElementRelation(path, maxBlockSize, magic, useDirectBuffer, isSplitable)(sqlContext)
  }
